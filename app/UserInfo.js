...
export default class UserInfo extends Component{
  ...
  _recommendReportByMonth(thiz){
    ...
    Global.Post('app/appRecommend!recommendDetail.do',
    'sessionkey='+Global.LoginBean.sessionKey,
    function(ret){
    ...
    return(
      <View>
        ...
        <TouchableWithoutFeedback  onPress={this._onBack.bind(this)}>
          ...
          <Text style={{width:width-50,color:'#fff',fontSize:17,textAlign:'center'}}>Awesome
          </Text>
        </View>
      <ScrollView
       style={{backgroundColor:Global.theme_bgColor}}>

        <View
          style={{width:width, flexDirection:'column', backgroundColor:Global.theme_color_icon}}
          >

          <Image style={{width:80,height:80,marginTop:25,alignSelf: 'center',borderRadius:80}} resizeMode="center" source={require('./../img/login_icon.jpg')}></Image>
          <Text style={[styles.text_title,{marginTop:20}]}>
            工号:{Global.LoginBean.userSeq}  身份:{Global.LoginBean.userType}
          </Text>
          <Text style={[styles.text_title,{marginTop:10,marginBottom:15}]}>
      ...
      <View style={{flexDirection:'row'}}>
        <View style={styles.month_detail}>
          <Text style={[styles.text_month_detail,{marginLeft:0}]}>
      ...
      <Act_Item marginTop={0.5} onPress={()=>{this._test2}} menu_name='我的tj'/>

    <Act_Item marginTop={10} onPress={()=>{this._test2}} menu_name='我的sc'/>

  <Act_Item marginTop={0.5} onPress={()=>{this._test2}} menu_name='意见反馈'/>

  <Act_Item marginTop={0.5} onPress={()=>{this._test2}} menu_name='系统消息'/>
